...
class Bird {
  constructor(speed = random(-5,5), scalar = random(10,70), angle = random(2,5), randomBird = floor(random(0,3))){
    this.x = random(width)
    ...
    this.image3 = loadGif("img/bird3.gif")
  ...
  show(){
    ...
    }else if(this.randomBird===2){
      image(this.image3, this.x, this.y + (this.scalar * sin(this.angleToRadians())), 90, 50);
    }
